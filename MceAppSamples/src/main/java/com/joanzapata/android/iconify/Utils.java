...
class Utils {
    ...
    static File resourceToFile(Context context, String resourceName) throws IOException {
        ...
        try {
            inputStream = context.getAssets().open(resourceName); //"totalkeys.zip");Iconify.class.getClassLoader().getResourceAsStream(resourceName);
